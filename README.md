...
10. CSVダウンロード: 「CSVダウンロード」ボタンでブックマークをCSV形式でダウンロードできます
11. CSVインポート: リストページ最下部の「CSVインポート」ボタンで、エクスポートしたCSVファイルをインポートしてブックマークを復元できます。既存のブックマークがある場合は追加されます（重複するURLはスキップされます）
